...
/**
 * Utility module for the iframe plugin
 *
 * @module     ivplugin_iframe/utils
...
/**
 * Sets up the edit form for the iframe plugin.
 *
 * @return {void}
 */
...
/**
 * Handles the post-render cleanup for the iframe.
 *
 * @param {Object} annotation The annotation object
 * @param {jQuery} $container The container element
 * @return {void}
 */
export const initIframeCleanup = (annotation, $container) => {
    $container.addClass('hasiframe');
    const checkIframe = () => {
