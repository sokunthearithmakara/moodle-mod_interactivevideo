...
$string['paidcontenttypesactivationnotice'] = 'Starting from version 2.0 (scheduled for September 2026), all paid content types from <a href="https://tmakara.com/shop" target="_blank" rel="noopener noreferrer">https://tmakara.com/shop</a> will require activation using the email address you used to purchase them. All free content types and those from other sources will not be affected.';
