...
$string['activationerror_invalid_payload'] = 'Invalid activation request.';
$string['activationerror_not_configured'] = 'License activation is not configured on this site.';
$string['activationerror_not_registered'] = 'This site is not registered for that plugin.';
$string['activationerror_purchase_not_found'] = 'No active purchase was found for this email and plugin.';
$string['activationerror_purchase_refunded'] = 'The purchase for this email and plugin was refunded.';
...
$string['allowdeleteprogress'] = 'Allow deleting own progress data';
$string['allowedfetchhosts'] = 'Additional provider hosts';
$string['allowedfetchhosts_desc'] = 'Extra hostnames the plugin may fetch video metadata from, one per line. Only needed for self-hosted providers on a custom domain, such as a Panopto server that is not on panopto.com or panopto.eu. Prefix an entry with "*." to allow its subdomains, for example *.video.example.edu. Leave empty unless a provider fails to load.';
...
$string['autolaunch'] = 'Auto-launch';
$string['autolaunch_desc'] = 'If checked, the interaction will be launched automatically when the video reaches the specified time. Otherwise, the user must click the interaction indicator to start the interaction.';
...
$string['cachedef_iv_activation'] = 'Content type activation status cache';
$string['cachedef_iv_items_by_cmid'] = 'Cache definitions for Interactive Video items by course module ID';
$string['cachedef_iv_plugins_catalog'] = 'Cached remote content types catalog';
...
$string['clickability_desc'] = 'If checked, the interaction indicator can be clicked to view the interaction content before/after it is completed.';
...
$string['completiondatadeleted'] = 'Completion data has been reset for this interaction.';
...
$string['confirmdeletedefault'] = 'Are you sure you want to delete the saved default for "{$a}"?';
...
$string['contenttypeactivated'] = 'Activated';
...
$string['customsegment'] = 'Custom video segment';
$string['customsegment_help'] = 'Enter the start and end time for the video. Right-click an input to set the current time from the preview player. Ctrl/Cmd + click on the start field resets to 0; on the end field resets to the full video duration.';
...
$string['defaultdeleted'] = 'Default deleted successfully.';
...
$string['deletecompletiondesc'] = 'If checked, the completion data can be deleted before/after the completion of the Interactive Video activity.';
...
$string['deleteownprogress'] = 'Are you sure you want to reset your progress? This action will delete all current attempts and associated files. Your current grade in the gradebook will not be affected but will be updated when you re-attempt the activity.';
...
$string['deletethiscompletion'] = 'Delete completion data';
$string['deletethiscompletiondesc'] = 'Are you sure you want to delete completion data for this interaction? This action will delete all current attempts and associated files.';
...
$string['errordeletingprogress'] = 'There was an error deleting your progress. Please try again later.';
...
$string['fbdescription'] = 'Add video content with custom start and end times.';
$string['fetchurlnotallowed'] = 'This URL is not a supported video provider address.';
...
$string['gumlet'] = 'Gumlet';
$string['hidecontrol'] = 'Hide control';
...
$string['interactiondefaults'] = 'Interaction defaults';
...
$string['invalidcolumn'] = 'The column "{$a->field}" is required.';
...
$string['invalidxpvalue'] = 'Please enter an XP value between 0 and the interaction maximum.';
...
$string['nodefaultssaved'] = 'No interaction defaults have been saved for this course.';
...
$string['overridexperror'] = 'Could not save the overridden XP. Please try again.';
$string['overridexpsaved'] = 'XP updated.';
$string['paidcontenttypesactivationnotice'] = 'Paid content types from <a href="https://tmakara.com/shop" target="_blank" rel="noopener noreferrer">https://tmakara.com/shop</a> require activation using the email address you purchased them with. Until a content type is activated it cannot be added to an activity, and its existing interactions are hidden from learners and locked for editing. Existing grades are not affected. Free content types and those from other sources do not require activation.';
$string['paidcontenttypesactivationnoticeheading'] = 'Important';
...
$string['purchaseemail'] = 'Purchase email';
$string['purchaseemail_desc'] = 'Enter the email address you used to purchase this plugin. To de-activate the plugin, empty this field.';
...
$string['studentscompleted'] = 'Students completed';
$string['studentsended'] = 'Students watched till the end';
$string['studentsstarted'] = 'Students started';
...
$string['task_refreshlicensing'] = 'Refresh Interactive Video content type licensing';
...
$string['updateavailable'] = 'Download update';
...
$string['videourlempty'] = 'Video URL cannot be empty';
$string['videourlinvalid'] = 'Video URL is invalid.';
$string['videourlplaceholder'] = 'Enter the URL of the video or upload a file';
$string['vidyard'] = 'Vidyard';
$string['views'] = 'Views';
$string['vimeo'] = 'Vimeo';
$string['viostream'] = 'Viostream';
$string['visibilityonvideonav'] = 'Visible on video navigation';
$string['visibilityonvideonav_desc'] = 'If checked, the interaction indicator will be visible on the video navigation bar before/after it is completed.';
$string['watch'] = 'Watch';
$string['watched'] = 'Watched %';
$string['watchedpercentage'] = 'Watched percentage';
$string['watchtillend'] = 'Watch till the end';
