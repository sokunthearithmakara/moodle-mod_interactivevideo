...
$string['fastforward200'] = 'Fast forward 0.2s';
...
$string['privacy:metadata:completiondetails'] = 'The completion details of the user.';
$string['privacy:metadata:completionid'] = 'The ID of the completion.';
$string['privacy:metadata:completionpercentage'] = 'The completion percentage of the user.';
$string['privacy:metadata:interactivevideo_completion'] = 'The user\'s completion status for the interactive video activity.';
$string['privacy:metadata:interactivevideo_log'] = 'The user\'s log for the interactive video activity.';
...
$string['privacy:metadata:timecompleted'] = 'The time the user completed the activity.';
...
$string['privacy:metadata:xp'] = 'The experience points earned by the user.';
$string['redo'] = "Redo";
