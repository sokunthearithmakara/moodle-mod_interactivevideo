...
$string['customsegment_help'] = 'Enter the start and end time for the video. You can also right-click on the input fields to set the current time from the preview player.';
