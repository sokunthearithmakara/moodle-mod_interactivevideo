...
(function( factory ){
	if ( typeof define === 'function' && define.amd ) {
		// AMD
		define( ['jquery', 'mod_interactivevideo/libraries/jquery.dataTables', 'mod_interactivevideo/libraries/dataTables.buttons'], function ( $ ) {
		...
		var cjsRequires = function (root, $) {
			if ( ! $.fn.dataTable ) {
				require('mod_interactivevideo/libraries/jquery.dataTables')(root, $);
			}
